    ...
    <div class="row">
        ...
        <div class="col-md-6">
            ...
            ?>
                    ...
                    ?>
                            <div class="col-auto">
                                <button type="button" data-toggle="lightbox" data-title="<?= Yii::t('front', 'Правила ухода за одеждой') ?>" data-remote="<?= Url::to(['/care'], true) ?> #page-content" class="btn btn-link px-0 text-decoration-underline">
                                    <?= Yii::t('front', 'Уход') ?>
                                </button>
                            </div>
                            <div class="col-auto">
