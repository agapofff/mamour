    ...
    <div class="row">
        ...
        <div class="col-md-6">
            ...
            ?>
                    ...
                    ?>
                            <div class="col-auto">
                                <button type="button" class="btn btn-link px-0 text-decoration-underline" data-toggle="popover" title="<?= Yii::t('front', 'Уход') ?>" data-content="<?= Html::encode(str_replace('"', "'", $productHoToUse)) ?>">
                                    <?= Yii::t('front', 'Уход') ?>
                                </button>
                            </div>
                    <?php
