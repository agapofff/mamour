    ...
    <div class="row">
        ...
        <div class="col-md-6">
            ...
            ?>
                    ...
                    <p class="mb-1_5">
                        <button type="button" data-toggle="lightbox" data-title="<?= Yii::t('front', 'Таблица размеров') ?>" data-remote="<?= Url::to(['/sizes'], true) ?> #page-content" data-modal-dialog-class="modal-dialog-centered" data-max-height="420" class="btn btn-link p-0 font-weight-light text-warning text-decoration-underline">
                            <small>
