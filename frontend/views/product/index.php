    ...
    <div class="row">
        ...
        <div class="col-md-6">
            ...
            ?>
                    ...
                    ?>
                            <div class="col-auto">
                                <button type="button" class="btn btn-link px-0 text-decoration-underline" data-toggle="popover" title="<?= Yii::t('front', 'Уход') ?>" data-content="$('#howToUse')">
                                    <?= Yii::t('front', 'Уход') ?>
                                </button>
                                <div id="hoToUse" class="d-none"><?= Html::encode($productHoToUse) ?></div>
                            </div>
                    <?php
                        }
                    ?>
